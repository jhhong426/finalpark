...
<html>
  <head>
    ...
    <!-- Theme style -->
    <link href="/resources/dist/img/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
    <!-- AdminLTE Skins. Choose a skin from the css/skins 
         folder instead of downloading all of them to reduce the load. -->
    <link href="/resources/dist/img/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />
